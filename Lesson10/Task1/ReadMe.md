# Инструкция
## Описание
Программа предназначена для выполнения бинарных арифметических операций над рациональными и комплексными числами. Программа реализована в виде Telegram-бота по имени <i>lesson10calcbot</i>
## Меню
