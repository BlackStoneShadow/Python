...
class Range:
    ...
    def validate(self, value):
        if not (isinstance(value, int) or isinstance(value, float)):
            raise NegativeValueError(f'свойство "{self.param_name}" должно быть вещественным числом')
        elif self.min_value is not None and value < self.min_value:
            raise NegativeValueError(f'{"Высота" if self.param_name == "_height" else "Ширина" } должна быть положительной, а не {value}')
